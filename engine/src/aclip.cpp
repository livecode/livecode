...
IO_stat MCAudioClip::extendedload(MCObjectInputStream& p_stream, MCStringRef p_version, uint4 p_length)
{
...
IO_stat MCAudioClip::load(IO_handle stream, MCStringRef version)
{
	IO_stat stat;
