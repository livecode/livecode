...
IO_stat MCColors::extendedload(MCObjectInputStream& p_stream, MCStringRef p_version, uint4 p_length)
{
...
IO_stat MCColors::load(IO_handle stream, MCStringRef version)
{
	IO_stat stat;
