...
MC_EXEC_DEFINE_EVAL_METHOD(Math, Abs, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, RoundToPrecision, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Round, 2)
...
MC_EXEC_DEFINE_EVAL_METHOD(Math, Atan2, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Cos, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Sin, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Tan, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Exp, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Exp1, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Exp2, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Exp10, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Ln, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Ln1, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Log2, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Log10, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Sqrt, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Annuity, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Compound, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Average, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Median, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Min, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Max, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, StdDev, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Sum, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Random, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, BitwiseAnd, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, BitwiseNot, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, BitwiseOr, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, BitwiseXor, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Div, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, DivArrayByNumber, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, DivArrayByArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Subtract, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, SubtractNumberFromArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, SubtractArrayFromArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Mod, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, ModArrayByNumber, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, ModArrayByArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Wrap, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, WrapArrayByNumber, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, WrapArrayByArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Over, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, OverArrayByNumber, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, OverArrayByArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Add, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, AddNumberToArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, AddArrayToArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Multiply, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, MultiplyArrayByNumber, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, MultiplyArrayByArray, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, Power, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, IsAnInteger, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, IsNotAnInteger, 2)
MC_EXEC_DEFINE_EVAL_METHOD(Math, IsANumber, 2)
...
MC_EXEC_DEFINE_EVAL_METHOD(Math, ArithmeticMean, 3)
MC_EXEC_DEFINE_EVAL_METHOD(Math, SampleStdDev, 3)
MC_EXEC_DEFINE_GET_METHOD(Math, RandomSeed, 1)
MC_EXEC_DEFINE_SET_METHOD(Math, RandomSeed, 1)

MC_EXEC_DEFINE_EXEC_METHOD(Math, DivideNumberByNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, DivideArrayByNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, DivideArrayByArray, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, AddNumberToNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, AddNumberToArray, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, AddArrayToArray, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, MultiplyNumberByNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, MultiplyArrayByNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, MultiplyArrayByArray, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, SubtractNumberFromNumber, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, SubtractNumberFromArray, 3)
MC_EXEC_DEFINE_EXEC_METHOD(Math, SubtractArrayFromArray, 3)
