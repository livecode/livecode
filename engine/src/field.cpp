...
MCPropertyInfo MCField::kProperties[] =
{
	...
	DEFINE_RW_OBJ_LINE_CHUNK_MIXED_PROPERTY(P_LIST_DEPTH, UInt16, MCField, ListDepth)
	DEFINE_RW_OBJ_LINE_CHUNK_MIXED_PROPERTY(P_LIST_INDENT, Int16, MCField, ListIndent)
	...
	DEFINE_RO_OBJ_LINE_CHUNK_EFFECTIVE_MIXED_PROPERTY(P_SPACE_BELOW, OptionalUInt16, MCField, SpaceBelow)
	...
	DEFINE_RW_OBJ_LINE_CHUNK_MIXED_CUSTOM_PROPERTY(P_BACK_COLOR, InterfaceNamedColor, MCField, BackColor)
	DEFINE_RW_OBJ_LINE_CHUNK_MIXED_CUSTOM_PROPERTY(P_BORDER_COLOR, InterfaceNamedColor, MCField, BorderColor)
