...
MCPropertyInfo MCField::kProperties[] =
{
	...
	DEFINE_RW_OBJ_LINE_CHUNK_NON_EFFECTIVE_MIXED_PROPERTY(P_SPACE_ABOVE, OptionalInt16, MCField, SpaceAbove)
	DEFINE_RO_OBJ_LINE_CHUNK_EFFECTIVE_MIXED_PROPERTY(P_SPACE_ABOVE, Int16, MCField, SpaceAbove)
	DEFINE_RW_OBJ_LINE_CHUNK_NON_EFFECTIVE_MIXED_PROPERTY(P_SPACE_BELOW, OptionalInt16, MCField, SpaceBelow)
	DEFINE_RO_OBJ_LINE_CHUNK_EFFECTIVE_MIXED_PROPERTY(P_SPACE_BELOW, Int16, MCField, SpaceBelow)
