...
public:
	...
	bool GetFrames(MCImageFrame *&r_frames, uint32_t &r_frame_count);
	...
	bool TakeFrames(MCImageFrame *&r_frames, uint32_t &r_count);
...
protected:
	...
	virtual bool LoadFrames(MCImageFrame *&r_frames, uint32_t &r_count) = 0;
