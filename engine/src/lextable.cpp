...
{
    {"arrow", kCValueTypeInteger, {.integer=29}},
    {"backslash", kCValueTypeString, {.string="\\"}},
    {"busy", kCValueTypeInteger, {.integer=6}},
    {"clock", kCValueTypeInteger, {.integer=14}},
    {"colon", kCValueTypeString, {.string=":"}},
    {"comma", kCValueTypeString, {.string=","}},
    {"cr", kCValueTypeString, {.string="\n"}},
    {"crlf", kCValueTypeString, {.string="\r\n"}},
    {"cross", kCValueTypeInteger, {.integer=7}},
    {"done", kCValueTypeString, {.string="done"}},
    {"down", kCValueTypeString, {.string="down"}},
    {"eight", kCValueTypeInteger, {.integer=8}},
    {"empty", kCValueTypeEmpty, {0}},
    {"end", kCValueTypeString, {.string="\004"}},
    {"endoffile", kCValueTypeString, {.string="\004"}},
    {"eof", kCValueTypeString, {.string="\004"}},
    {"false", kCValueTypeFalse, {0}},
    {"five", kCValueTypeInteger, {.integer=5}},
    {"formfeed", kCValueTypeString, {.string="\014"}},
    {"four", kCValueTypeInteger, {.integer=4}},
    {"hand", kCValueTypeInteger, {.integer=28}},
    {"help", kCValueTypeInteger, {.integer=15}},
    {"ibeam", kCValueTypeInteger, {.integer=9}},
    {"infinity", kCValueTypeInfinity, {0}},
    {"left", kCValueTypeString, {.string="left"}},
    {"lf", kCValueTypeString, {.string="\n"}},
    ...
    {"plus", kCValueTypeInteger, {.integer=13}},
    {"quote", kCValueTypeString, {.string="\""}},
    {"return", kCValueTypeString, {.string="\n"}},
    {"right", kCValueTypeString, {.string="right"}},
    {"scrollbarfactor", kCValueTypeInteger, {.integer=65535}},
    {"seven", kCValueTypeInteger, {.integer=7}},
    {"six", kCValueTypeInteger, {.integer=6}},
    {"slash", kCValueTypeString, {.string="/"}},
    {"space", kCValueTypeString, {.string=" "}},
    {"tab", kCValueTypeString, {.string="\t"}},
    {"ten", kCValueTypeInteger, {.integer=10}},
    {"three", kCValueTypeInteger, {.integer=3}},
    {"true", kCValueTypeTrue, {0}},
    {"two", kCValueTypeInteger, {.integer=2}},
    {"up", kCValueTypeString, {.string="up"}},
    {"watch", kCValueTypeInteger, {.integer=14}},
    {"zero", kCValueTypeInteger, {.integer=0}},
};
