...
// SN-2014-10-01: [[ Bug 13539 ]] Popup menus changed to inherit NSPanel instead of NSWindow,
...
void MCMacPlatformWindow::DoRealize(void)
{
    ...
    // SN-2014-10-01: [[ Bug 13539 ]] Ugly hack: we want all the pulldown menus to work, even when there is a modal window.
