...
IO_stat MCMagnify::load(IO_handle stream, MCStringRef version)
{
	return MCObject::load(stream, version);
}

IO_stat MCMagnify::extendedload(MCObjectInputStream& p_stream, MCStringRef p_version, uint4 p_length)
{
