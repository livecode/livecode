...
float android_font_measure_text(void *p_font, const char *p_text, uint32_t p_text_length, bool p_is_unicode)
{
	...
	else
	{
        ...
        MCStringCreateWithCString(p_text);
        MCAutoStringRefAsUTF8String t_utf8_string;
        /* UNCHECKED */ t_utf8_string . Lock(*t_string);
        
        /* UNCHECKED */ MCAndroidTypefaceMeasureText(t_font->typeface, t_font->size, *t_utf_string, MCStringGetLength(*t_string), false, t_length);
	}
