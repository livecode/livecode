...
void MCMetaContext::drawtext(int2 x, int2 y, MCStringRef p_string, MCFontRef p_font, Boolean image, MCDrawTextBreaking p_can_break, MCDrawTextDirection p_direction)
{
    MCRange t_range;
...
void MCMetaContext::drawtext_substring(int2 x, int2 y, MCStringRef p_string, MCRange p_range, MCFontRef p_font, Boolean image, MCDrawTextBreaking p_can_break, MCDrawTextDirection p_direction)
{
