...
public:
	...
	void drawtext(int2 x, int2 y, MCStringRef p_string, MCFontRef p_font, Boolean image, MCDrawTextDirection = kMCDrawTextDirectionLTR, MCDrawTextBreaking = kMCDrawTextBreak);
    void drawtext_substring(int2 x, int2 y, MCStringRef p_string, MCRange p_range, MCFontRef p_font, Boolean image, MCDrawTextDirection = kMCDrawTextDirectionLTR, MCDrawTextBreaking = kMCDrawTextBreak);
