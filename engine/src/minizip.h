...
typedef bool (*MCMiniZipListItemsCallback)(MCListRef& r_list, MCStringRef name);
...
bool MCMiniZipListItems(MCMiniZipRef self, MCMiniZipListItemsCallback callback, MCListRef &context);
