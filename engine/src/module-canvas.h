...
extern "C" MC_DLLEXPORT void MCCanvasBeginLayerWithEffectForRect(MCCanvasEffectRef p_effect, MCCanvasRectangleRef p_rect, MCCanvasRef p_canvas);
extern "C" MC_DLLEXPORT void MCCanvasBeginEffectOnlyLayerWithEffect(MCCanvasEffectRef p_effect, MCCanvasRef p_canvas);
extern "C" MC_DLLEXPORT void MCCanvasBeginEffectOnlyLayerWithEffectForRect(MCCanvasEffectRef p_effect, MCCanvasRectangleRef p_rect, MCCanvasRef p_canvas);
