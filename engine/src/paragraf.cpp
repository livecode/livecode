...
{ 
    ...
    if (parent->gettextdirection() == kMCFieldTextDirectionLTR)
        ...
        t_base_level = MCUnicodeGetFirstStrongIsolate(m_text, 0);
    
    MCAutoArray<uint8_t> t_levels;
    
    // SN-2014-04-03 [[ Bug 12075 ]] Text direction resolving relocated in foundation-unicode
    MCUnicodeResolveDirection(m_text, t_base_level, t_levels . PtrRef(), t_levels . SizeRef());
