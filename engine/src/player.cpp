...
IO_stat MCPlayer::extendedload(MCObjectInputStream& p_stream, MCStringRef p_version, uint4 p_remaining)
{
...
IO_stat MCPlayer::load(IO_handle stream, MCStringRef version)
{
	IO_stat stat;
