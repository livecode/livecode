...
{
	MCresult -> clear();
	if (!MCSystemLaunchUrl(p_document_string))
...
void MCS_savetextfile(MCStringRef p_filename, MCStringRef p_string)
{
	MCAutoStringRef t_resolved_path;
...
void MCS_savebinaryfile(MCStringRef p_filename, MCDataRef p_data)
{
	MCAutoStringRef t_resolved_path;
