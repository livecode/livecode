...
void MCWebViewBrowser::PrintToPDF(const char *pFilename, uint32_t p_width, uint32_t p_height)
{
    ...
    NSString * t_filename = [NSString stringWithCString:pFilename encoding:NSUTF8StringEncoding];
