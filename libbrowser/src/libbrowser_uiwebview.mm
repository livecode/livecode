...
void MCUIWebViewBrowser::PrintToPDF(const char *p_filename, uint32_t p_width, uint32_t p_height)
{
    __block UIWebView *t_view;
    if (!GetView(t_view))
        return;
    ...
    MCBrowserRunBlockOnMainFiber(^{
        ...
        UIPrintFormatter *t_formatter = t_view.viewPrintFormatter;
