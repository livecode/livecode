...
{
    return UnicodeToUTF8((const uint16_t*)wchars, wchar_count * 2, utf8bytes, utf8byte_count);
#if 0
...
{
    return UTF8ToUnicode(utf8bytes, utf8byte_count, (uint16_t*)wchars, wchar_count * 2) / 2;
#if 0
