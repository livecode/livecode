...
/*
'condition' SyntaxHasExpressionAsPrefix(SYNTAX)

    'rule' SyntaxHasExpressionAsPrefix(concatenate(_, Left, Right)):
        SyntaxHasExpressionAsPrefix(Left)
        
    'rule' SyntaxHasExpressionAsPrefix(alternate(_, Left, Right)):
        SyntaxHasExpressionAsPrefix(Left)
        SyntaxHasExpressionAsPrefix(Right)
        
    'rule' SyntaxHasExpressionAsPrefix(repeat(_, Element)):
        SyntaxHasExpressionAsPrefix(Element)

    'rule' SyntaxHasExpressionAsPrefix(list(_, Element, _)):
        SyntaxHasExpressionAsPrefix(Element)
        
    'rule' SyntaxHasExpressionAsPrefix(rule(_, Name)):
        QueryId(Name -> Meaning)
        (|
            where(Meaning -> syntaxexpressionrule)
        ||
            where(Meaning -> syntaxrule(_, Syntax))
            SyntaxHasExpressionAsPrefix(Syntax)
        |)

    'rule' SyntaxHasExpressionAsPrefix(markedrule(_, _, Name)):
        QueryId(Name -> Meaning)
        (|
            where(Meaning -> syntaxexpressionrule)
        ||
...
'condition' SyntaxHasExpressionAsSuffix(SYNTAX)

    'rule' SyntaxHasExpressionAsSuffix(concatenate(_, Left, Right)):
        SyntaxHasExpressionAsSuffix(Right)
        
    'rule' SyntaxHasExpressionAsSuffix(alternate(_, Left, Right)):
        SyntaxHasExpressionAsSuffix(Left)
        SyntaxHasExpressionAsSuffix(Right)
        
    'rule' SyntaxHasExpressionAsSuffix(repeat(_, Element)):
        SyntaxHasExpressionAsSuffix(Element)

    'rule' SyntaxHasExpressionAsSuffix(list(_, Element, _)):
        SyntaxHasExpressionAsSuffix(Element)
        
    'rule' SyntaxHasExpressionAsSuffix(rule(_, Name)):
        QueryId(Name -> Meaning)
        (|
            where(Meaning -> syntaxexpressionrule)
        ||
            where(Meaning -> syntaxrule(_, Syntax))
            SyntaxHasExpressionAsSuffix(Syntax)
        |)

    'rule' SyntaxHasExpressionAsSuffix(markedrule(_, _, Name)):
        QueryId(Name -> Meaning)
        (|
            where(Meaning -> syntaxexpressionrule)
        ||
