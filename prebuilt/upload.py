...
def upload(args):
    ...
    print('Uploading target platform prebuilts (' + target_platform + ',' + target_arch + ',' + target_subplatform + ')')
    exec_upload_prebuilts(target_platform, target_arch, target_subplatform)
