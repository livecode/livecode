...
def usage(exit_status):
    print(
"""Upload prebuilts needed to build LiveCode.
...
def exec_upload_prebuilts(build_platform, build_arch, build_subplatform):
...
def upload(args):
    ...
    print('Uploading target platform prebuilts (' + opts['TARGET_PLATFORM'] + ',' + opts['TARGET_ARCH'] + ',' + opts['TARGET_SUBPLATFORM'] + ')')
    exec_upload_prebuilts(opts['TARGET_PLATFORM'], opts['TARGET_ARCH'], opts['TARGET_SUBPLATFORM'])
