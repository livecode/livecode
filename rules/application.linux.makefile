...
LDFLAGS=$(LDFLAGS_$(ARCH)) $(CUSTOM_LDFLAGS) $(addprefix -L,$(GLOBAL_LIBS)) -Xlinker -no-undefined $(addprefix -Xlinker --exclude-libs -Xlinker ,$(addsuffix .a,$(addprefix lib,$(STATIC_LIBS))))
