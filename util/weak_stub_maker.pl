...
output "  t_module = NULL;";
output "#if defined(_MACOSX) || defined(_MAC_SERVER)";
output "  t_module  = (module_t)NSAddImage(p_source, NSADDIMAGE_OPTION_RETURN_ON_ERROR | NSADDIMAGE_OPTION_WITH_SEARCHING);";
output "#endif";
...
output "  t_symbol = NSLookupSymbolInImage((mach_header *)p_module, p_name, NSLOOKUPSYMBOLINIMAGE_OPTION_BIND_NOW);";
